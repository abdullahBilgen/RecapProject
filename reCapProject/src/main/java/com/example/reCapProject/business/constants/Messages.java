...
public class Messages {
	...
	public static final String CARREPAIRRENTERROR = "Araba bakımdan çıkmadı kiralanamaz.";
	...
	public static final String RENTREPAIRERROR = "Araba bakımdan çıktı kiralanabilir.";
	...
	public static final String CARDAMAGEDELETE = "Car Damage deleted.";
	public static final String CARDAMAGELIST = "Cars Damage listed.";
