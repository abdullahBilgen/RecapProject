...
public class CreditCardManager implements CreditCardService {
	...
	@Override
	public DataResult<List<CreditCard>> getCreditCardByCustomerId(int userId) {

		return new SuccessDataResult<List<CreditCard>>(this.creditCardDao.getCreditCardByCustomer_UserId(userId),
